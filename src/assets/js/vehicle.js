document.addEventListener("DOMContentLoaded", () => {
    ...
    // Add default option for the make dropdown
    ...
    // In-memory storage for vehicles (with localStorage for persistence)
    let vehicles = [];
    ...
    // Function to update the "My Vehicles" list
    ...
    // Update the list on initial page load
    updateVehicleList();
